...
public void user_should_be_able_to_Navigate_to_OrangeHRM_Application_LogIn_Page()
	...
	WebElement OrangeHRMApplicationLogInPageLogInPanel=driver.findElement
													(logInPanelLocator);
	String actual_OrangeHRMApplicationLogInPageLogInPanelText=
						OrangeHRMApplicationLogInPageLogInPanel.getText();
		
		if(actual_OrangeHRMApplicationLogInPageLogInPanelText.equals
								(expected_OrangeHRMApplicationLogInPageText))
	{
		...
		{
		System.out.println
			("Failed to Navigate to OrangeHRM Application LogIn Page - FAIL");
		}
		
Assert.assertEquals("Failed to Navigate to OrangeHRM  LogIn Page - FAIL",
		expected_OrangeHRMApplicationLogInPageText,
		actual_OrangeHRMApplicationLogInPageLogInPanelText);
	}
...
public void user_should_enter_and_and_click_on_logIn_button
